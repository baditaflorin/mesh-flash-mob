...
**Live → https://baditaflorin.github.io/mesh-flash-mob/**

**Source → https://github.com/baditaflorin/mesh-flash-mob**
...
git clone https://github.com/baditaflorin/mesh-flash-mob
cd mesh-flash-mob
npm install
npm run dev
```
...
- `mesh-flash-mob:signalingUrl`
- `mesh-flash-mob:turnTokenUrl`
- `mesh-flash-mob:iceServers`
- `mesh-flash-mob:room`
